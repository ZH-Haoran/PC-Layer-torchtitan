...
class JobConfig:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            "--metrics.wandb_comment",
            type=str,
            default="",
            help="Comment to add to wandb run",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--optimizer.beta2", type=float, default=0.999, help=""
        )
        self.parser.add_argument(
            "--optimizer.eps", type=float, default=1e-8, help=""
        )
        self.parser.add_argument(
            "--optimizer.fused",
            default=False,
        ...
        self.parser.add_argument(
            "--training.dataset_train_path",
            type=str,
            default="",
            help="Path to training dataset",
        )
        self.parser.add_argument(
            "--training.dataset_val_path",
            type=str,
            default="",
        ...
        self.parser.add_argument(
            "--training.num_val_batch",
            type=int,
            default=50,
            help="Number of batches for calculating validation loss",
        )
        self.parser.add_argument(
            "--training.val_interval",
            type=int,
            default=100,
            help="Iteration interval for calculating validation loss",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="Enable visualization mode (skip training, run SVD analysis on checkpoint)",
        )
        self.parser.add_argument(
            "--visualize.step",
            type=str,
            default="-1",
            help="Checkpoint steps to analyze. -1 for all steps, or comma-separated list (e.g., '1,2000,60000')",
        )
